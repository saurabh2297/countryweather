...
let $col2 = elemCreate('DIV',['col-12'])
...
//let s_div = elemCreate("DIV",['input-group','mb-3'])
//let s_ip = elemCreate("INPUT",['form-control'])
//s_ip.type = "text";
//s_ip.placeholder = "Search with country name";
//s_ip.ariaDescribedby = "basic-addon2";
//let s_div2 = elemCreate('DIV',['input-group-append'])
//let s_btn = elemCreate("BUTTON",['btn','btn-success'])
//s_btn.innerText = "Search"
//s_btn.type = "button";
//s_div2.append(s_btn)
//s_div.append(s_ip,s_div2)
